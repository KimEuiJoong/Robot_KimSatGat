...
from poem.views import PoemViewSet,CommentViewSet,LikeViewSet,Recommend,MyLikeList,MyPoemList,MyRecommendList,AdminPoemViewSet,Surveyin,LikeFeedback
...
urlpatterns = format_suffix_patterns([
    ...
    path('poems/survey', Surveyin),
    path('poems/likefeedback', LikeFeedback),
